# Cycle Control — AI Design V2.1.1
...
Each agent's opponent pool is drawn from the full multi-agent population, not just its own snapshots:
...
This means every agent faces opponents with different strategic priorities during training, which is the core diversity mechanism.
