# Cycle Control — AI Implementation Checklist V2.4

**Status:** operational checklist derived from `AI_DESIGN_V2.3`, tuned by practitioner evidence (Huang 2022, SIMPLE self-play, ML-Agents, Tablut AlphaZero reproduction, CleanRL, PettingZoo)  
...
Curriculum approach: run Phase 0 first on R=4, then R=7, then R=10, using the smaller-board checkpoint as initialization for the larger board (with appropriate tensor/graph reshaping).
